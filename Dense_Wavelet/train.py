...
if __name__ == "__main__":
    ...
    # Training parameters
    parser.add_argument('--epochs', type = int, default = 80, help = 'number of epochs of training') # for second stage, change it to 30
    parser.add_argument('--start_epoch', type = int, default = 1, help = 'epoch number to start from (1-based, set >1 to resume training)')
    parser.add_argument('--batch_size', type = int, default = 3, help = 'size of the batches')
    parser.add_argument('--crop_size', type = int, default = 136, help = 'crop size')
    ...
    parser.add_argument('--in_root', type = str, default = r"C:\Users\DoseOptics\Desktop\Denoising_Project\Denoising_Models\Dense_Wavelet\Data\Simulated_singleframe2", help = 'color image baseroot')   #replace with path to data folder
    parser.add_argument('--gt_root', type = str, default = r"C:\Users\DoseOptics\Desktop\Denoising_Project\Denoising_Models\Dense_Wavelet\Data\Simulated_cumulative", help = 'color image baseroot')
    parser.add_argument('--val_root', type = str, default = r"C:\Users\DoseOptics\Desktop\Denoising_Project\Denoising_Models\Dense_Wavelet\Data\Simulated_singleframe2_val", help = 'color image baseroot')   #replace with path to data folder
    parser.add_argument('--gtval_root', type = str, default = r"C:\Users\DoseOptics\Desktop\Denoising_Project\Denoising_Models\Dense_Wavelet\Data\Simulated_cumulative_val", help = 'color image baseroot')
