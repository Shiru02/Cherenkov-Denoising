...
# ==============================================================================
try:
    from palette_diffusion_clear_img import PaletteUNet, DiffusionSchedule, DiffusionSampler
except ImportError:
    print("Error: Could not import from palette_diffusion_clear_img.py")
...
def parse_args():
    p = argparse.ArgumentParser(description='Evaluation script for Palette Diffusion (Clear Img) on Full Images')

    p.add_argument('--checkpoint', type=str,
                   default=r"E:\Chr_denoise\experiments\palette_diffusion_clear_img\checkpoints\best_model.pth",
    ...
    p.add_argument('--output_dir', type=str,
                   default=r"E:\Chr_denoise\palette_clear_img_evaluation_results_full",
